 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sO=-1;class Se extends $u{constructor(e,n,r,i){super(e,n,r,i),this.type="firestore",this._queue=new rO,this._persistenceKey=(i==null?void 0:i.name)||"[DEFAULT]"}_terminate(){return this._firestoreClient||yT(this),this._firestoreClient.terminate()}}function Ke(t){return t._firestoreClient||yT(t),t._firestoreClient.verifyNotTerminated(),t._firestoreClient}function yT(t){var e,n,r;const i=t._freezeSettings(),s=function(o,a,u,l){return new OR(o,a,u,l.host,l.ssl,l.experimentalForceLongPolling,l.experimentalAutoDetectLongPolling,dT(l.experimentalLongPollingOptions),l.useFetchStreams)}(t._databaseId,((e=t._app)===null||e===void 0?void 0:e.options.appId)||"",t._persistenceKey,i);t._firestoreClient=new Wb(t._authCredentials,t._appCheckCredentials,t._queue,s),!((n=i.cache)===null||n===void 0)&&n._offlineComponentProvider&&(!((r=i.cache)===null||r===void 0)&&r._onlineComponentProvider)&&(t._firestoreClient._uninitializedComponentsProvider={_offlineKind:i.cache.kind,_offline:i.cache._offlineComponentProvider,_online:i.cache._onlineComponentProvider})}function oO(t,e){wT(t=Z(t,Se));const n=Ke(t);if(n._uninitializedComponentsProvider)throw new E(_.FAILED_PRECONDITION,"SDK cache is already specified.");un("enableIndexedDbPersistence() will be deprecated in the future, you can use `FirestoreSettings.cache` instead.");const r=t._freezeSettings(),i=new Zg;return vT(n,i,new oT(i,r.cacheSizeBytes,e==null?void 0:e.forceOwnership))}function aO(t){wT(t=Z(t,Se));const e=Ke(t);if(e._uninitializedComponentsProvider)throw new E(_.FAILED_PRECONDITION,"SDK cache is already specified.");un("enableMultiTabIndexedDbPersistence() will be deprecated in the future, you can use `FirestoreSettings.cache` instead.");const n=t._freezeSettings(),r=new Zg;return vT(e,r,new zb(r,n.cacheSizeBytes))}function vT(t,e,n){const r=new je;return t.asyncQueue.enqueue(async()=>{try{await jl(t,n),await Lp(t,e),r.resolve()}catch(i){const s=i;if(!aT(s))throw s;un("Error enabling indexeddb cache. Falling back to memory cache: "+s),r.reject(s)}}).then(()=>r.promise)}function uO(t){if(t._initialized&&!t._terminated)throw new E(_.FAILED_PRECONDITION,"Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");const e=new je;return t._queue.enqueueAndForgetEvenWhileRestricted(async()=>{try{await async function(n){if(!nn.D())return Promise.resolve();const r=n+"main";await nn.delete(r)}(Lg(t._databaseId,t._persistenceKey)),e.resolve()}catch(n){e.reject(n)}}),e.promise}function lO(t){return function(e){const n=new je;return e.asyncQueue.enqueueAndForget(async()=>xb(await ny(e),n)),n.promise}(Ke(t=Z(t,Se)))}function cO(t){return Hb(Ke(t=Z(t,Se)))}function hO(t){return Qb(Ke(t=Z(t,Se)))}function dO(t,e){const n=Ke(t=Z(t,Se)),r=new iO;return Zb(n,t._databaseId,e,r),r}function fO(t,e){return eO(Ke(t=Z(t,Se)),e).then(n=>n?new rt(t,null,n.query):null)}function wT(t){if(t._initialized||t._terminated)throw new E(_.FAILED_PRECONDITION,"Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function PO(t){t=Z(t,he);const e=Z(t.firestore,Se);return cT(Ke(e),t._key).then(n=>py(e,t,n))}class Ji extends fy{constructor(e){super(),this.firestore=e}convertBytes(e){return new xn(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new he(this.firestore,null,n)}}function bO(t){t=Z(t,he);const e=Z(t.firestore,Se),n=Ke(e),r=new Ji(e);return Yb(n,t._key).then(i=>new Hn(e,r,t._key,i,new gi(i!==null&&i.hasLocalMutations,!0),t.converter))}function OO(t){t=Z(t,he);const e=Z(t.firestore,Se);return cT(Ke(e),t._key,{source:"server"}).then(n=>py(e,t,n))}function PT(t){t=Z(t,rt);const e=Z(t.firestore,Se),n=Ke(e),r=new Ji(e);return AT(t._query),hT(n,t._query).then(i=>new Vr(e,r,t,i))}function LO(t){t=Z(t,rt);const e=Z(t.firestore,Se),n=Ke(e),r=new Ji(e);return Xb(n,t._query).then(i=>new Vr(e,r,t,i))}function MO(t){t=Z(t,rt);const e=Z(t.firestore,Se),n=Ke(e),r=new Ji(e);return hT(n,t._query,{source:"server"}).then(i=>new Vr(e,r,t,i))}function _0(t,e,n){t=Z(t,he);const r=Z(t.firestore,Se),i=Kh(t.converter,e,n);return Vu(r,[Bh(Yi(r),"setDoc",t._key,i,t.converter!==null,n).toMutation(t._key,fe.none())])}function I0(t,e,n,...r){t=Z(t,he);const i=Z(t.firestore,Se),s=Yi(i);let o;return o=typeof(e=U(e))=="string"||e instanceof Ur?ay(s,"updateDoc",t._key,e,n,r):oy(s,"updateDoc",t._key,e),Vu(i,[o.toMutation(t._key,fe.exists(!0))])}function $O(t){return Vu(Z(t.firestore,Se),[new go(t._key,fe.none())])}function FO(t,e){const n=Z(t.firestore,Se),r=Bc(t),i=Kh(t.converter,e);return Vu(n,[Bh(Yi(t.firestore),"addDoc",r._key,i,t.converter!==null,{}).toMutation(r._key,fe.exists(!1))]).then(()=>r)}function jc(t,...e){var n,r,i;t=U(t);let s={includeMetadataChanges:!1},o=0;typeof e[o]!="object"||Mp(e[o])||(s=e[o],o++);const a={includeMetadataChanges:s.includeMetadataChanges};if(Mp(e[o])){const h=e[o];e[o]=(n=h.next)===null||n===void 0?void 0:n.bind(h),e[o+1]=(r=h.error)===null||r===void 0?void 0:r.bind(h),e[o+2]=(i=h.complete)===null||i===void 0?void 0:i.bind(h)}let u,l,c;if(t instanceof he)l=Z(t.firestore,Se),c=po(t._key.path),u={next:h=>{e[o]&&e[o](py(l,t,h))},error:e[o+1],complete:e[o+2]};else{const h=Z(t,rt);l=Z(h.firestore,Se),c=h._query;const d=new Ji(l);u={next:p=>{e[o]&&e[o](new Vr(l,d,h,p))},error:e[o+1],complete:e[o+2]},AT(t._query)}return function(h,d,p,y){const w=new Mh(y),A=new Wg(d,w,p);return h.asyncQueue.enqueueAndForget(async()=>jg(await no(h),A)),()=>{w.Dc(),h.asyncQueue.enqueueAndForget(async()=>qg(await no(h),A))}}(Ke(l),c,a,u)}function UO(t,e){return Jb(Ke(t=Z(t,Se)),Mp(e)?e:{next:e})}function Vu(t,e){return function(n,r){const i=new je;return n.asyncQueue.enqueueAndForget(async()=>Cb(await ny(n),r,i)),i.promise}(Ke(t),e)}function py(t,e,n){const r=n.docs.get(e._key),i=new Ji(t);return new Hn(t,i,e._key,r,new gi(n.hasPendingWrites,n.fromCache),e.converter)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function D0(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(YT(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(HT(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(XT(e))return"Blackberry";if(JT(e))return"Webos";if(Iy(e))return"Safari";if((e.includes("chrome/")||QT(e))&&!e.includes("edge/"))return"Chrome";if(zu(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=t.match(n);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function HT(t=we()){return/firefox\//i.test(t)}function Iy(t=we()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function QT(t=we()){return/crios\//i.test(t)}function YT(t=we()){return/iemobile/i.test(t)}function zu(t=we()){return/android/i.test(t)}function XT(t=we()){return/blackberry/i.test(t)}function JT(t=we()){return/webos/i.test(t)}function Eo(t=we()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function Y2(t=we()){return/(iPad|iPhone|iPod).*OS 7_\d/i.test(t)||/(iPad|iPhone|iPod).*OS 8_\d/i.test(t)}function X2(t=we()){var e;return Eo(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function J2(){return c1()&&document.documentMode===10}function ZT(t=we()){return Eo(t)||zu(t)||JT(t)||XT(t)||/windows phone/i.test(t)||YT(t)}function Z2(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ek(t,e=[]){let n;switch(t){case"Browser":n=D0(we());break;case"Worker":n=`${D0(we())}-${t}`;break;default:n=t}const r=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Gr}/${r}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
